...
import { ReceiptStoryFrame } from '@/features/debts/receipt/ReceiptStoryFrame';
import {
  saveReceiptToPhotos,
  shareReceiptImage,
...
export interface PrintedReceiptShareScreenProps {
...
export function PrintedReceiptShareScreen({
  receiptData,
  tiltSeed,
  onClose,
  screenTitle = 'Receipt',
}: PrintedReceiptShareScreenProps) {
